...
//            alert(_id);
            ...
            $.get('<?php echo admin_url("pages/update_gallery_status"); ?>', {id: _id, status: _status},
            //alert(data);
                    function (data) {
                        _this.text(data);
                        $('a#' + _id + '').addClass(data);
...
<div class="container-fluid">
    <div class="page-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url("admin/pages/add_gallery");?>"><i class="fa fa-plus"></i> Create/add new Image</a>
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <tbody>
                                <?php
                                //var_dump($gallery_details);
                                if (!empty($gallery_details)) {
                                    $count= 1;
                                    foreach ($gallery_details as $galleryData) {
                                        $galleryId = $galleryData->image_id;
                                        $galleryTitle = $galleryData->image_title;
                                        $galleryName = $galleryData->image_name;
                                        $galleryDetails = $galleryData->description;
                                        $galleryStatus = $galleryData->status;
                                        $galleryOrder = $galleryData->order;
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td class='center'>
                                        <ul class="gallery">
                                            <li>
                                                <a href="#">
                                                    <img src="<?php echo base_url() ?>assets_admin/createThumb/create_thumb.php?src=<?php echo ROOT; ?>uploads/gallery/<?php echo $galleryName; ?>&w=80&h=80" alt="" />
                                                </a>
                                                <div class="extras">
                                                    <div class="extras-inner">
                                                        <a href="<?php echo base_url(); ?>uploads/gallery/<?php echo $galleryName; ?>" class='colorbox-image' rel="group-1">
                                    ...
                                    <td class='center'><?php echo $galleryTitle ?></td>
                                    <td class="publish_status">
                                            <a href="javascript:;" id="<?php echo $galleryId; ?>"  style="margin:5px; padding:5px 10px;">
                                                <?php echo @$galleryStatus; ?>
                                            </a>
                                        </td>
                                    <td>
                                        <a class="edit" href="<?php echo base_url("admin/pages/edit_gallery/$galleryId")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure to delete <strong><?php echo $galleryTitle;?></strong>. </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="<?php echo base_url("admin/pages/delete_gallery/$galleryId");?>" class="btn btn-danger">Delete</a>
