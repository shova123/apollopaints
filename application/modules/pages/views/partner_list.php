...
<div class="container-fluid">
    <div class="page-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
               <a class="btn btn-success" href="<?php echo base_url("admin/pages/add_partner");?>"><i class="fa fa-plus"></i> Create/add new partner</a>
                ...
                <div class="box-content nopadding">
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <?php if (!empty($partner_details)) {
                                    $count = 1;
                                    foreach ($partner_details as $allpartner) {
                                        $edit_id = $allpartner->partner_id;
                                        $partnerImage = $allpartner->partner_image;
                                        $partnerName = $allpartner->partner_title;
                                        $partnerLink = $allpartner->partner_link;
                                        ?>

                                        <tr>

                                            <td><?php echo $count; ?></td>
                                            <td><strong><?php echo $partnerName; ?></strong></td>
                                            <td><?php echo $partnerLink; ?></td>
                                    <td>
                                        <a class="edit" href="<?php echo base_url("admin/pages/edit_partner/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                        <p>
                                                           Are you sure to delete this link (<strong><?php echo $partnerName;?></strong>).
                                                        </p>
                                                    </div>
                                                    <!-- /.modal-body -->
                                                    <div class="modal-footer">
                                                        <a href="<?php echo base_url("admin/pages/delete_partner/$edit_id");?>" class="btn btn-danger">Delete</a>
