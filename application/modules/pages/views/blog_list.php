...
<div class="container-fluid">
    <div class="page-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
               <a class="btn btn-success" href="<?php echo base_url("admin/pages/add_blog");?>"><i class="fa fa-plus"></i> Create/add new page</a>
                    ...
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <?php if(!empty($page_details)){
                            ...
                            foreach($page_details as $allpage){
                                $edit_id = $allpage->blog_id;
                                $pageTitle = $allpage->blog_title;
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                        <p>
                                                           Are you sure to delete this Blog (<strong><?php echo $pageTitle;?></strong>).
                                                        </p>
                                                    </div>
                                                    <!-- /.modal-body -->
                                                    <div class="modal-footer">
                                                        <a href="<?php echo base_url("admin/pages/delete_blog/$edit_id");?>" class="btn btn-danger">Delete</a>
