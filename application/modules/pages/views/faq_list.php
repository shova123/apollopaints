...
<div class="container-fluid">
    <div class="page-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url("admin/pages/add_faq");?>"><i class="fa fa-plus"></i> Create/add new FAQ</a>
                    ...
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <?php if(!empty($page_details)){
                            ...
                            foreach($page_details as $allpage){
                                $edit_id = $allpage->faq_id;
                                $pageTitle = $allpage->faq_title;
                                $Order = $allpage->order;
                                ...
                                <tr><!--gradeA, gradeC, gradeX, gradeU -->
                                    ...
                                    <td>
                                        <a class="edit" href="<?php echo base_url("admin/pages/edit_faq/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>
                                                            Are you sure to delete this Course (<strong><?php echo $pageTitle;?></strong>).
                                                        </p>
                                                    </div>
                                                    <!-- /.modal-body------->
                                                    <div class="modal-footer">
                                                        <a href="<?php echo base_url("admin/pages/delete_faq/$edit_id");?>" class="btn btn-danger">Delete</a>
