...
<div class="container-fluid">
    <div class="page-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url("admin/pages/add_slide");?>"><i class="fa fa-plus"></i> Create/add new slide</a>
                ...
                <div class="box-content nopadding">
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <?php if(!empty($slide_details)){
                                    $count=1;
                            foreach($slide_details as $allslide){
                                $edit_id = $allslide->slide_id;
                                $slideImage = $allslide->slide_img;
                                $slideDESC = $allslide->slide_description;
                                $order = $allslide->order;
                                $slideTITLE = $allslide->slide_title;
                                ...
                                <tr>
                                    ...
                                    <td align="center"> <ul class="gallery">
                                                <li>
                                                    <a href="#">
                                                        <img src="<?php echo base_url(); ?>assets_admin/createThumb/create_thumb.php?src=<?php echo ROOT; ?>uploads/slide/<?php echo $slideImage; ?>&w=80&h=80" alt="" />
                                                    </a>
                                                    <div class="extras">
                                                        <div class="extras-inner">
                                                            <a href="<?php echo base_url(); ?>uploads/slide/<?php echo $slideImage; ?>" class='colorbox-image' rel="group-1">
                                    ...
                                    <td><strong><?php echo $slideDESC;?></strong></td>
                                    <td><?php echo $order ?></td>
                                    <td>
                                        <a class="edit" href="<?php echo base_url("admin/pages/edit_slide/$edit_id")?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                            ...
                                            <div class="modal-dialog">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p>Are you sure to delete <strong><?php echo $slideImage;?></strong>. </p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <a href="<?php echo base_url("admin/pages/delete_slide/$edit_id");?>" class="btn btn-danger">Delete</a>
