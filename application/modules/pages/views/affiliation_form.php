...
<?php $timestamp = time(); ?>
      $(function() {
            ...
            'formData': {
                ...
                'targetFolder': '/appolo/uploads/affiliation/',
            ...
            onUploadComplete: function (file, data, response) {
                ...
                $('.imagethumbs-form').prepend('<div class="imagethumb-form additional-file-input" id="add-image1" title="menson"> <a class="close-msg" title="Delete" id="deleteImg">Delete</a> <a href="#" title="'+data+'" class="img-wrap"><img src="'+"<?php echo base_url(); ?>"+'assets_admin/createThumb/create_thumb.php?src='+imagePath+'uploads/affiliation/'+data+'&w=150&h=150" alt="'+data+'" /></a></div>');
                //alert($('#fileList').val());                  
...
$(function(){
    ...
    $(document).on('click', '#deleteImg', function () {
        ...
        delete_image(_img);
        $.post("<?php echo admin_url("pages/delete_affiliation_image");?>",{imgName:_img},
        function(data){
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form action="" method="POST" name="addEditform" id="addEditform" class="addEditform form-horizontal form-bordered form-validate" enctype='multipart/form-data' >
                        <input type="hidden" id="fileList" name="fileList" value="<?php if ($isEdit) echo $details->affiliation_image; ?>" />

                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Affiliation Name</label>
                                <div class="col-sm-10">
                                    <input data-rule-required="true" data-rule-minlength="2" type="text" name="affiliation_name" id="affiliation_name" value="<?php if (@$isEdit) echo $details->affiliation_title; ?>" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" data-rule-required="true" type="text" placeholder="Only numbers" name="affiliation_link" value="<?php if (@$isEdit) echo $details->affiliation_link; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="file" name="affiliation_image" id="affiliation_image" /><!--class="form-control"-->
                                    <div class="imagethumbs-form">
                                        <?php
                                        if ($isEdit) {
                                            $imgname = $details->affiliation_image;
                                            $img = explode(':', $imgname);
                                            //dumparray($img);
                                            if (!empty($imgname)) {
                                                echo '';
                                                foreach ($img as $i) {
                                                    ...
                                                    <div class="imagethumb-form additional-file-input" id="add-image1">
                                                        ...
                                                        <a href="#" title="<?php echo $i; ?>" class="img-wrap">
                                                            <img src="<?php echo base_url(); ?>assets_admin/createThumb/create_thumb.php?src=<?php echo ROOT; ?>uploads/affiliation/<?php echo $i; ?>&w=150&h=150" />
                                                        </a>
                                                    </div>
                                                    <?php
                                                }
                        ...
                        <div class="form-actions">
                            <input type="submit" name="AffiliationSubmit" class="btn btn-primary" value="SUBMIT">
                            <!--<button type="submit" class="btn btn-primary">Save changes</button>-->
                            <a href="<?php echo base_url("admin/pages/affiliation");?>"><button type="button" class="btn">Cancel</button></a>
                        </div>
                    </form>
                </div>
            </div>
