...
$(function() {
  $('#category_image').uploadifive({
            ...
            'formData': {
                ...
                'targetFolder': '/appolo/uploads/category/',
            ...
            onUploadComplete: function (file, data, response) {
                ...
                $('.imagethumbs-form').prepend('<div class="imagethumb-form additional-file-input" id="add-image1" title="menson"> <a class="close-msg" title="Delete" id="deleteImg">Delete</a> <a href="#" title="'+data+'" class="img-wrap"><img src="'+"<?php echo base_url(); ?>"+'assets_admin/createThumb/create_thumb.php?src='+imagePath+'uploads/category/'+data+'&w=150&h=150" alt="'+data+'" /></a></div>');
                //alert($('#fileList').val());                  
...
$(function(){
    //$('a#deleteImg').live('click',function(){
        ...
        delete_image(_img);
        $.post("<?php echo admin_url("product/delete_category_image");?>",{imgName:_img},
            function(data){
...
<?php $isEdit = isset($cat_details) ? true : false;?>
                ...
                <div class="box-title">
                    ...
                    <div class="box-content nopadding">
                        <form action="" method="post" id="addEditform" name="addEditform" class="addEditform form-horizontal form-bordered form-validate" enctype='multipart/form-data' >
                            <input type="hidden" id="fileList" name="fileList" value="<?php if ($isEdit) {echo $cat_details->category_image;}?>" />

                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Category Title</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="category_title" name="category_title" placeholder="Enter Category Title" value='<?php
                                    if ($isEdit) {
                                        echo $cat_details->category_title;
                                    }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control slug" id="category_slug" name="category_slug" placeholder="Slug Recognition"  value="<?php
                                    if ($isEdit) {
                                        echo $cat_details->category_slug;
                                    }
                                    ?>" readonly="">
                                </div>   
                            </div>
<!--                             <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    if (!empty($isEdit)) {
                                        $checkboxd = explode(",", $cat_details->display_type);
                                    }
                                    ?>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="short_note" id="short_note" placeholder="Short Description For Home Page" class="form-control" value="<?php if (@$isEdit) echo $cat_details->short_note; ?>"> 
                                </div>
                            </div> -->
                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Category Description</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id='category_description' rows="3" name="category_description" placeholder="Enter ..." ><?php
                                    if ($isEdit) {
                                        echo $cat_details->category_description;
                                    }
                                    ?></textarea>
                                </div>
                            </div>
<!--                             <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="featured" id="featured" class="tagsinput form-control" value="<?php if (@$isEdit) echo $cat_details->featured; ?>">
                            </div>
                           </div> -->
                            <div class="form-group">
                                <div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="status">
                                        ...
                                        if ($isEdit) {
                                            if ($cat_details->status == 'Unpublish') {
                                                echo 'selected';
                                            }
                                        }
                                        ?>>Unpublish</option>
                            ...
                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Category Image</label>
                                <div class="col-sm-10">
                                    ...
                                    <div class="imagethumbs-form">
                                        <?php
                                        if ($isEdit) {
                                            $imgname = $cat_details->category_image;
                                            $img = explode(':', $imgname);
                                                //dumparray($img);
                                            if (!empty($imgname)) {
                                                echo '';
                                                foreach ($img as $i) {
                                                    ...
                                                    <div class="imagethumb-form additional-file-input" id="add-image1">
                                                        ...
                                                        <a href="#" title="<?php echo $i; ?>" class="img-wrap">
                                                            <img src="<?php echo base_url(); ?>assets_admin/createThumb/create_thumb.php?src=<?php echo ROOT; ?>uploads/category/<?php echo $i; ?>&w=150&h=150" />
                                                        </a>  
                                                    </div>
                                                    <?php
                                                }
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    if ($isEdit) {
                                        echo $cat_details->html_description;
                                    }
                                    ?></textarea>
                                </div>
                            </div>
                            <div class="form-actions">
                                <input type="submit" name="catSubmit" class="btn btn-primary" value="SUBMIT">
                                <!--<button type="submit" class="btn btn-primary">Save changes</button>-->
                                <a href="<?php echo base_url("admin/product/product_list/$slug");?>"><button type="button" class="btn">Cancel</button>
                                </div>
                            </form>
                        </div>
                    </div>
