...
$(function() {
  $('#sample_image').uploadifive({
            ...
            onUploadComplete: function (file, data, response) {
                ...
                $('.imagethumbs-form').prepend('<div class="imagethumb-form additional-file-input" id="add-image1" title="menson"> <a class="close-msg" title="Delete" id="deleteImg">Delete</a> <a href="#" title="'+data+'" class="img-wrap"><img src="'+"<?php echo base_url(); ?>"+'assets_admin/createThumb/create_thumb.php?src='+imagePath+'uploads/samples/'+data+'&w=150&h=150" alt="'+data+'" /></a></div>');
                //alert($('#fileList').val());                  
...
$(function(){
    //$('a#deleteImg').live('click',function(){
        ...
        delete_image(_img);
        $.post("<?php echo admin_url("color_visualizer/delete_sample_image");?>",{imgName:_img},
            function(data){
...
<?php $isEdit = isset($sample_details) ? true : false;?>
                ...
                <div class="box-title">
                    ...
                    <div class="box-content nopadding">
                        <form action="" method="post" id="addEditform" name="addEditform" class="addEditform form-horizontal form-bordered form-validate" enctype='multipart/form-data' >
                            <input type="hidden" id="fileList" name="fileList" value="<?php if ($isEdit) {echo $sample_details->sample_image;}?>" />

                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Sample Title</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="sample_title" name="sample_title" placeholder="Enter Sample Title" value='<?php
                                    if ($isEdit) {
                                        echo $sample_details->sample_title;
                                    }
                            ...
                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Sample Slug</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control slug" id="sample_slug" name="sample_slug" placeholder="Slug Recognition"  value="<?php
                                    if ($isEdit) {
                                        echo $sample_details->sample_slug;
                                    }
                                    ?>" readonly="">
                                </div>   
                            </div>
<!--                             <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <?php
                                    if (!empty($isEdit)) {
                                        $checkboxd = explode(",", $sample_details->display_type);
                                    }
                                    ?>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="short_note" id="short_note" placeholder="Short Description For Home Page" class="form-control" value="<?php if (@$isEdit) echo $sample_details->short_note; ?>"> 
                                </div>
                            </div> -->
<!--                             <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Sample Description</label>
                                <div class="col-sm-10">
                                    <textarea class="form-control" id='sample_description' rows="3" name="sample_description" placeholder="Enter ..." ><?php
                                    if ($isEdit) {
                                        echo $sample_details->sample_description;
                                    }
                                    ?></textarea>
                                </div>
                            </div> -->
<!--                             <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="featured" id="featured" class="tagsinput form-control" value="<?php if (@$isEdit) echo $sample_details->featured; ?>">
                            </div>
                           </div> -->
                            <div class="form-group">
                                <div>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="col-sm-3">
                                    <select class="form-control" name="status">
                                        ...
                                        if ($isEdit) {
                                            if ($sample_details->status == 'Publish') {
                                                echo 'selected';
                                            }
                                        }
                                        ?>>Publish</option>
                                        ...
                                        if ($isEdit) {
                                            if ($sample_details->status == 'Unpublish') {
                                                echo 'selected';
                                            }
                                        }
                                        ?>>Unpublish</option>
                            ...
                            <div class="form-group">
                                <label for="textfield" class="control-label col-sm-2">Sample Image</label>
                                <div class="col-sm-10">
                                    ...
                                    <div class="imagethumbs-form">
                                        <?php
                                        if ($isEdit) {
                                            // $imgname = $sample_images->sample_image;
                                            // $img = explode(':', $imgname);
                                                //dumparray($img);
                                            if (!empty($sample_images)) {
                                                echo '';
                                                foreach ($sample_images as $i) {
                                                    ?>
                                                    <div class="imagethumb-form additional-file-input" id="add-image1">
                                                        <a class="close-msg" title="Delete" id="deleteImg">Delete</a>
                                                        <a href="#" title="<?php echo $i->sample_image; ?>" class="img-wrap">
                                                            <img src="<?php echo base_url(); ?>assets_admin/createThumb/create_thumb.php?src=<?php echo ROOT; ?>uploads/samples/<?php echo $i->sample_image; ?>&w=150&h=150" />
                                                        </a>  
                                                    </div>
                                                    <?php
                                                }
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    if ($isEdit) {
                                        echo $sample_details->html_title;
                                    }
                                    ?>'>
                                </div>
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    if ($isEdit) {
                                        echo $sample_details->html_keyword;
                                    }
                                    ?>'>
                                </div>
                            </div> -->
                            ...
                            <!-- <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    if ($isEdit) {
                                        echo $sample_details->html_description;
                                    }
                                    ?></textarea>
                                </div>
                            </div> -->
                            <div class="form-actions">
                                ...
                                <a href="<?php echo base_url("admin/color_visualizer/sample_list/$slug");?>"><button type="button" class="btn">Cancel</button>
                                </div>
                            </form>
                        </div>
                    </div>
