...
//            alert(_id);
            ...
            $.get('<?php echo admin_url("color_visualizer/update_sample_status"); ?>', {id: _id, status: _status},
            //alert(data);
                    function (data) {
                        _this.text(data);
                        $('a#' + _id + '').addClass(data);
...
<div class="container-fluid">
    <div class="page-header">
        ...
        <div class="pull-right">
            ...
            <div class="btn-group">
                <a class="btn btn-success" href="<?php echo base_url("admin/color_visualizer/add_sample/$slug"); ?>"><i class="fa fa-plus"></i> Create/Add New Sample Image</a>
                    ...
                    <table class="table table-hover table-nomargin table-bordered dataTable">
                        ...
                        <tbody>
                            ...
                            if (!empty($sample_details)) {
                                $count = 1;
                                foreach ($sample_details as $sampleData) {
                                    $sampleId = $sampleData->sample_id;
                                    $sampleTitle = $sampleData->sample_title;
                                    $sampleSlug = $sampleData->sample_slug;
                                    // $sampleDisplay = $sampleData->display_type;
                                    $sampleImg = $sampleData->sample_image;
                                    $sampleStatus = $sampleData->status;
                                    $sampleOrder = $sampleData->order;
                                    ?>
...
<!--                                         <td align="center"> <ul class="gallery">
                                                <li>
                                                    <a href="#">
                                                        <img src="<?php echo base_url() ?>assets_admin/createThumb/create_thumb.php?src=<?php echo ROOT; ?>uploads/sample/<?php echo $sampleImg; ?>&w=80&h=80" alt="" />
                                                    </a>
                                                    <div class="extras">
                                                        <div class="extras-inner">
                                                            <a href="<?php echo base_url(); ?>uploads/sample/<?php echo $sampleImg; ?>" class='colorbox-image' rel="group-1">
                                        ...
                                        <td align="center"><?php echo $sampleTitle; ?></td>
                                         <!-- <td align="center"><?php echo str_replace(",", " || ", ucfirst($sampleDisplay)); ?></td> -->
                                        <td class="publish_status">
                                            <a href="javascript:;" id="<?php echo $sampleId; ?>"  style="margin:5px; padding:5px 10px;">
                                                <?php echo @$sampleStatus; ?>
                                            </a>
                                        </td>

                                        <td align="center">
                                            <a class="edit" href="<?php echo base_url("admin/color_visualizer/edit_sample/$sampleId/$slug/$sampleSlug") ?>"><button class="btn btn-xs btn-primary"><i class="fa fa-pencil"></i></button></a>
                                                ...
                                                <div class="modal-dialog">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p>Are you sure to delete <strong><?php echo $sampleTitle; ?></strong>. </p>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <a href="<?php echo base_url("admin/color_visualizer/delete_sample/$sampleId/$slug/$sampleSlug"); ?>" class="btn btn-danger">Delete</a>
