    ...
    <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" valign="top" bgcolor="#fedd02" style="background-color:#fedd02; padding:6px;"><table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-bottom:10px;">
          <tr>
            <td align="left" valign="top"><img src="http://hotelhimalayaninn.com/resources/email_templates/Mustard_Company_Newsletter/Default/images/logo.png" width="298" height="67" style="display:block;"></td>
          </tr>
        </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="5" style="margin-bottom:20px;">
            <tr>
              <td width="50%" align="left" valign="top" bgcolor="#000000" style="background-color:#000000; color:#ffffff; font-family:Verdana, Geneva, sans-serif; font-size:11px;">&nbsp;&nbsp;Month Day, Year </td>
              <td align="right" valign="top" bgcolor="#000000" style="background-color:#000000; color:#ffffff; font-family:Verdana, Geneva, sans-serif; font-size:11px;">issue #&nbsp;&nbsp;</td>
            </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="10" style="margin-bottom:10px;">
            <tr>
              <td align="left" valign="top" style="color:#000000; font-family:Arial, Helvetica, sans-serif; font-size:38px;">NEWSLETTER TITLE</td>
              </tr>
          </table>
          <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
            <tr>
              <td align="center" valign="top"><img src="http://hotelhimalayaninn.com//resources/email_templates/Mustard_Company_Newsletter/Default/images/divider1.png" width="587" height="6" style="display:block;"></td>
            </tr>
          </table></td>
      </tr>
      <tr>
        <td align="center" valign="top" bgcolor="#fedd02" style="background-color:#fedd02; padding:6px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="195" align="left" valign="top"><table width="160" border="0" cellpadding="0" cellspacing="7" style="margin-bottom:10px;">
              ...
              <tr>
                <td align="center" valign="top"><img src="http://hotelhimalayaninn.com//resources/email_templates/Mustard_Company_Newsletter/Default/images/right_divider.png" width="152" height="10" style="display:block;" /></td>
              </tr>
            </table>
              ...
              <table width="160" border="0" cellpadding="0" cellspacing="7" style="margin-bottom:10px;">
                <tr>
                  <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-size:13px;"><div style="font-size:16px;"><b>Featured Article </b></div>
                    <div><img src="http://hotelhimalayaninn.com//resources/email_templates/Mustard_Company_Newsletter/Default/images/pic003.jpg" width="144" height="94"><br>
...
<div><br>
  ...
  <br>
              ...
              <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom:10px;">
                <tr>
                  <td align="center" valign="top"><img src="http://hotelhimalayaninn.com//resources/email_templates/Mustard_Company_Newsletter/Default/images/right_divider.png" width="374" height="10" style="display:block;"></td>
                </tr>
              </table>
                  ...
                  <td align="left" valign="top" style="font-family:Arial, Helvetica, sans-serif; color:#000000; font-size:13px;"><div style="font-size:16px;"><b>New Products</b></div>
                    <div>
                      ...
                      <table width="80%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="50%" align="left" valign="middle"><img src="http://hotelhimalayaninn.com//resources/email_templates/Mustard_Company_Newsletter/Default/images/pic001.jpg" width="118" height="118"></td>
                          <td align="left" valign="middle"><img src="http://hotelhimalayaninn.com//resources/email_templates/Mustard_Company_Newsletter/Default/images/pic002.jpg" width="119" height="119"></td>
                        </tr>
                      </table>
                      <br>
